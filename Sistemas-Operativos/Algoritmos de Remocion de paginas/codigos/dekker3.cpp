...
iniciar_procesos(); // inicializa y corre ambos hilos

proceso p1:
void main(){
	while(!no_terminado){
		p1_quiere_entrar = true; // seccion de entrada de la exclusion mutua
		while(p2_quiere_entrar); // seccion de entrada de la exclusion mutua
		// seccion critica
...
void main(){
	while(!no_terminado){
		...
		while(p1_quiere_entrar); // seccion de entrada de la exclusion mutua
		// seccion critica
